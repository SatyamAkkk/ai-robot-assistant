...
//       if (isMounted && !isSpeakingRef.current) {
//         setTimeout(() => {
//           if (isMounted) try { recognition.start(); } catch (e) {}
//         }, 1000);
//       }
//     };
...
//       if (!assistantName || transcript.toLowerCase().includes(assistantName.toLowerCase()) || transcript.length > 0) {
//         setUserText(transcript);
//         setAiText("Thinking...");
...
//       <h1 className='text-white text-[18px] font-semibold text-wrap text-center max-w-[80%]'>
